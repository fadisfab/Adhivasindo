...
-- ----------------------------
-- Sequence structure for pool_user_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."pool_user_id_seq";
CREATE SEQUENCE "public"."pool_user_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
...
-- ----------------------------
-- Table structure for pool_users
-- ----------------------------
DROP TABLE IF EXISTS "public"."pool_users";
CREATE TABLE "public"."pool_users" (
  "id" int8 NOT NULL DEFAULT nextval('pool_user_id_seq'::regclass),
  "nama" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "nim" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "ymd" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "data" json,
  "created_at" timestamp(0),
  "updated_at" timestamp(0)
)
...
CREATE TABLE "public"."users" (
  ...
  "created_at" timestamp(0),
  "updated_at" timestamp(0),
  "token" varchar(80) COLLATE "pg_catalog"."default"
)
;
...
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."pool_user_id_seq"
OWNED BY "public"."pool_users"."id";
SELECT setval('"public"."pool_user_id_seq"', 421, true);
...
-- ----------------------------
-- Uniques structure for table pool_users
-- ----------------------------
ALTER TABLE "public"."pool_users" ADD CONSTRAINT "pool_user_nim_unique" UNIQUE ("nim");

-- ----------------------------
-- Primary Key structure for table pool_users
-- ----------------------------
ALTER TABLE "public"."pool_users" ADD CONSTRAINT "pool_user_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Uniques structure for table users
-- ----------------------------
ALTER TABLE "public"."users" ADD CONSTRAINT "users_email_unique" UNIQUE ("email");
ALTER TABLE "public"."users" ADD CONSTRAINT "users_token_unique" UNIQUE ("token");
